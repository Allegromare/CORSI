...
fruits … in the United States. Retail stores are welcome to download the posters, 
print, display and/or distribute them to consumers in close proximity to the 
...
If k is a str and d is a dict, you can check whether k is a key in d with code 
like:
